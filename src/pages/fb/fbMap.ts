...
export class FbMapLocatePage {
  ...
  goBack(){
    this.storage.set('datafb',this.data);
    this.navCtrl.setRoot(FbPage,{data:this.data});
  }
  getRefresh(){
...
export class FbPinPointMapPage{
   data:any;
...
export class FbMapPage{
  ...
  setMapOnAll(map) {
   ...
   openModal(characterNum) {
    let modal = this.modalCtrl.create(ModalFbMap, characterNum);
    modal.present();
  }
}
